...
def scrape_article(url):
    ...
    if tawsiyat_metadata:
        try:
            ...
            article_data["keywords"] = tawsiyat_json.get("keywords", "No keywords found").split(',')
            article_data["thumbnail"] = tawsiyat_json.get("thumbnail", "No thumbnail found")
            article_data["word_count"] = tawsiyat_json.get("word_count", "No word count found")
            article_data["lang"] = tawsiyat_json.get("lang", "No language found")
            article_data["published_time"] = tawsiyat_json.get("published_time", "No published time found")
            article_data["last_updated"] = tawsiyat_json.get("last_updated", "No last updated time found")
            article_data["description"] = tawsiyat_json.get("description", "No description found")
